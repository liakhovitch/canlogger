...
uint8_t CANSPI_Transmit(uCAN_MSG *tempCanMsg) {
    ...
    if (ctrlStatus.TXB0REQ != 1) {
        ...
        MCP2515_LoadTxSequence(MCP2515_LOAD_TXB0SIDH, &(idReg.tempSIDH), tempCanMsg->frame.dlc,
        ...
        MCP2515_LoadTxSequence(MCP2515_LOAD_TXB1SIDH, &(idReg.tempSIDH), tempCanMsg->frame.dlc,
                               &(tempCanMsg->frame.data0));
        ...
        MCP2515_LoadTxSequence(MCP2515_LOAD_TXB2SIDH, &(idReg.tempSIDH), tempCanMsg->frame.dlc,
                               &(tempCanMsg->frame.data0));
...
uint8_t CANSPI_Receive(uCAN_MSG *tempCanMsg) {
    ...
    if (rxStatus.rxBuffer != 0) {
        ...
        if (rxStatus.msgType == dEXTENDED_CAN_MSG_ID_2_0B) {
            ...
            tempCanMsg->frame.id = convertReg2ExtendedCANid(rxReg.RXBnEID8, rxReg.RXBnEID0, rxReg.RXBnSIDH,
                                                            rxReg.RXBnSIDL);
        } else {
            /* Standard 타입 */
